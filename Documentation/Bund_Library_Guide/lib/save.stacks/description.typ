...
registered lambda functions, user functions, aliases, and the content of the stacks. Function _save.stacks_ performs the save stacks data into the WORLD file.
