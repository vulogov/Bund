...
pub fn init_stdlib(cli: &cmd::Cli) {
    ...
    let _ = bc.vm.register_inline("?stdlib".to_string(), stdlib_bund_is_stdlib);
    let _ = bc.vm.register_inline("?word".to_string(), stdlib_bund_is_callable);
    ...
    let _ = bc.vm.register_inline("lambda!".to_string(), stdlib_bund_to_lambda);
    let _ = bc.vm.register_inline("lambda*".to_string(), stdlib_bund_fold_lambda);
    drop(bc);
}
