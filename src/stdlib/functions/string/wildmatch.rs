...
pub fn init_stdlib(cli: &cmd::Cli) {
    ...
    let _ = bc.vm.register_inline("string.wildcard".to_string(), stdlib_string_stack_wildcard_inline);
    let _ = bc.vm.register_inline("string.wildcard.".to_string(), stdlib_string_workbench_wildcard_inline);
