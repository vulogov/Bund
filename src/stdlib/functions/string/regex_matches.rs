...
pub fn string_regex_matches_base(vm: &mut VM, op: StackOps, err_prefix: String) -> Result<&mut VM, Error> {
    match op {
        StackOps::FromStack => {
...
pub fn stdlib_string_workbench_regex_matches_inline(vm: &mut VM) -> Result<&mut VM, Error> {
    string_regex_matches_base(vm, StackOps::FromWorkBench, "STRING.REGEX.MATCHES.".to_string())
}
...
pub fn init_stdlib(cli: &cmd::Cli) {
    ...
    let _ = bc.vm.register_inline("string.regex.matches".to_string(), stdlib_string_stack_regex_matches_inline);
    let _ = bc.vm.register_inline("string.regex.matches.".to_string(), stdlib_string_workbench_regex_matches_inline);
